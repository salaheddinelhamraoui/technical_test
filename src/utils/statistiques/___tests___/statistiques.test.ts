import { getLandArea, scalePolygon } from "../statistiques";

describe("getLandArea", () => {
  it("should return the area of the polygon", () => {
    ...
    const area = getLandArea(coordinates);
    expect(area).toBe(7406.102332878188);
  });
});

// describe("scalePolygon", () => {
//   it("should return a scaled polygon", () => {
//     const polygon = {
//       type: "MultiPolygon",
//       coordinates: [
//         [
